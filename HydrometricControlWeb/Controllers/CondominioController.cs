using HydrometricControlWeb.Services;
...
namespace Hidro.Web.Controllers.Habitacao
{
    ...
    {
        private readonly CondominioApiClient _condominioApiClient;

        public CondominioController(CondominioApiClient condominioApiClient)
        {
            _condominioApiClient = condominioApiClient;
        }
        ...
        {
            var listaCondominios = await _condominioApiClient.Listar();
